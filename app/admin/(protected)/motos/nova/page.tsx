    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="flex flex-col gap-2 mb-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-foreground">Cadastrar motocicleta</h1>
            <p className="text-muted-foreground mt-1">Preencha os dados abaixo para criar um novo anúncio.</p>
          </div>
        </div>
      </div>
