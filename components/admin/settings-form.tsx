  ...
  const defaultValues: SettingsFormValues = {
    ...
    settings: {
      ...
      branding: {
        ...
        logoBase64: rawSettings.branding?.logoBase64 || rawSettings.logo_base64 || '',
    ...
    try {
      ...
      const payload = {
        ...
        settings: {
          ...
          logo_base64: data.settings.branding?.logoBase64 || rawSettings.branding?.logoBase64 || rawSettings.logo_base64 || '',
