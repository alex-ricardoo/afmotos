...
export function FipeSearchForm({
  ...
  return (
    <form
      ...
      className="rounded-2xl border border-border/80 bg-card p-6 shadow-md space-y-5"
    >
      <div className="flex items-center justify-between border-b border-border/60 pb-4">
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#c9a44c]/10 text-[#e3c56c] border border-[#c9a44c]/30">
            <Bike className="h-4 w-4" />
          </div>
          <div>
            <h3 className="font-bold text-base text-foreground">Formulário de Consulta</h3>
            <p className="text-xs text-muted-foreground">
              Selecione as especificações da motocicleta em sequência
            </p>
          </div>
        </div>
        ...
        <button
          type="button"
          onClick={handleClear}
          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors cursor-pointer"
        >
      ...
      <div className="space-y-4">
        ...
        <div className="hidden">
          ...
          <select
            ...
            className="w-full min-h-[48px] rounded-xl border border-border bg-background px-3.5 py-2.5 text-sm font-medium text-foreground focus:border-[#c9a44c] focus:ring-2 focus:ring-[#c9a44c]/20 outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div ref={brandComboboxRef} className="relative">
          <div className="flex items-center justify-between mb-2">
            <label className="block text-xs font-semibold text-foreground">Marca</label>
            <div className="flex items-center gap-2">
              {loadingBrands && (
          ...
          {/* Gatilho Visual do Select Marca (Para outras marcas) */}
          <div
            onClick={() => {
          ...
          >
            <span className={selectedBrand ? 'font-bold text-foreground' : 'text-muted-foreground'}>
              {selectedBrand
                ? selectedBrand.name
                : !selectedTypeId
          ...
          {isBrandOpen && (
            <div className="absolute left-0 right-0 top-full mt-1.5 z-50 rounded-xl border border-[#c9a44c]/40 bg-card/95 backdrop-blur-md shadow-2xl p-2 space-y-2 animate-in fade-in zoom-in-95 duration-150">
                      ...
                      <div
                        ...
                        className={`flex items-center justify-between min-h-[40px] px-3 py-2 rounded-lg text-xs cursor-pointer transition-colors ${
                          isSelected
                            ...
                            : 'text-foreground hover:bg-amber-500/15 hover:text-amber-500'
                        }`}
                      >
                        <span>{b.name}</span>
        ...
        <div ref={modelComboboxRef} className="relative">
          <div className="flex items-center justify-between mb-1.5">
            <label className="block text-xs font-semibold text-foreground">Modelo</label>
            {loadingModels && (
              <span className="inline-flex items-center gap-1 text-[11px] text-[#e3c56c]">
                <Loader2 className="h-3 w-3 animate-spin" />
          ...
          >
            <span className={selectedModel ? 'font-bold text-foreground' : 'text-muted-foreground'}>
              {selectedModel
                ? selectedModel.name
                : !selectedBrandId
          ...
          {isModelOpen && (
            <div className="absolute left-0 right-0 top-full mt-1.5 z-50 rounded-xl border border-[#c9a44c]/40 bg-card/95 backdrop-blur-md shadow-2xl p-2 space-y-2 animate-in fade-in zoom-in-95 duration-150">
              ...
              <div className="px-1 text-[11px] text-muted-foreground border-b border-border/40 pb-1.5">
                <span>
        ...
        <div className="grid grid-cols-2 gap-3.5">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="block text-xs font-semibold text-foreground">Ano/modelo</label>
              {loadingDetail && (
                <span className="inline-flex items-center gap-1 text-[11px] text-[#e3c56c]">
                  <Loader2 className="h-3 w-3 animate-spin" />
                </span>
            ...
            <select
              ...
              className="w-full min-h-[48px] rounded-xl border border-border bg-background px-3.5 py-2.5 text-sm font-medium text-foreground focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <option value="">
                {!selectedModelId
                  ? 'Selecione o modelo'
      ...
      <button
        ...
        className="w-full min-h-[48px] flex items-center justify-center gap-2 rounded-xl bg-amber-500 hover:bg-amber-600 text-zinc-950 px-4 py-3 text-sm font-bold shadow-md transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer mt-4"
      >
        {submitting ? (
          <>
