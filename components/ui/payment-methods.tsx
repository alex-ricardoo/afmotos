  ...
  return (
    <div className={cn('space-y-2.5', className)}>
      ...
      <div className="grid grid-cols-3 gap-2">
        {/* Dinheiro */}
        <div className="flex flex-col items-center gap-1.5 py-3 px-2 rounded-2xl bg-zinc-900/70 border border-zinc-800 text-center">
          <div className="w-8 h-8 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center">
            <Banknote className="w-4 h-4 text-emerald-400" />
          </div>
          <span className="text-[11px] font-bold text-zinc-200 leading-tight">Dinheiro</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-1.5 py-3 px-2 rounded-2xl bg-zinc-900/70 border border-zinc-800 text-center">
          ...
          <span className="text-[11px] font-bold text-zinc-200 leading-tight">PIX</span>
        </div>

        {/* Cartão */}
        <div className="flex flex-col items-center gap-1.5 py-3 px-2 rounded-2xl bg-amber-500/8 border border-amber-500/30 text-center">
          <div className="w-8 h-8 rounded-xl bg-amber-500/15 border border-amber-500/30 flex items-center justify-center">
            <CreditCard className="w-4 h-4 text-amber-400" />
          </div>
          <span className="text-[11px] font-bold text-amber-300 leading-tight">Cartão</span>
        </div>
      </div>
