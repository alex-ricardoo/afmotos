...
export function getVehicleHistoryFaqs(priceFormatted?: string): VehicleHistoryFaqItem[] {
  const priceText = priceFormatted || 'R$ 39,99';
  ...
  return [
    {
      ...
      answer:
        'Assim que o pagamento é confirmado, seu laudo é liberado instantaneamente na sua Área do Cliente. Você terá uma plataforma exclusiva onde todos os seus laudos ficam salvos para você consultar sempre que quiser, com acesso vitalício que nunca expira. Você pode visualizá-lo online no celular ou computador e baixar o laudo oficial em PDF autenticado a qualquer momento.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Com certeza! Na sua Área do Cliente você pode realizar quantas consultas quiser. Todas as placas consultadas ficam organizadas no seu painel exclusivo com acesso permanente, permitindo comparar veículos, reabrir laudos antigos sem custo adicional e manter todo o seu histórico centralizado.',
    },
    {
      id: 'qualquer-estado',
    ...
    },
    {
      ...
      answer:
        `Enquanto concorrentes cobram R$ 64,90 pela mesma consulta, oferecemos o histórico completo das bases oficiais por apenas ${priceText}, direto na plataforma, com laudo vitalício que nunca expira e suporte dedicado.`,
    },
    {
      id: 'tipos-veiculos',
...
export const VEHICLE_HISTORY_FAQS: VehicleHistoryFaqItem[] = getVehicleHistoryFaqs('R$ 39,99');
