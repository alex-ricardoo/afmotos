  ...
  if (success) {
    return (
      <div className="bg-green-50 border border-green-200 text-green-800 p-6 rounded-lg text-center">
        ...
        <p>Recebemos as informações da sua moto para consignação. Entraremos em contato em breve para detalhar o processo.</p>
        <Button className="mt-4" variant="outline" onClick={() => setSuccess(false)}>Enviar outra moto</Button>
      </div>
    );
  }
