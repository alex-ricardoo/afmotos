 ...
 */
export function PixBrandIcon({ className = 'h-5 w-5', ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
/**
 * Ícone Oficial Mercado Pago (Handshake emblem)
 */
export function MercadoPagoBrandIcon({ className = 'h-5 w-5', ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
/**
 * Ícone Profissional Cartão de Crédito (com chip e bandeiras)
 */
export function CreditCardBrandIcon({ className = 'h-5 w-5', ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
    ...
    >
      ...
      />
      {/* Tarja magnética */}
      <rect x="1.75" y="8" width="20.5" height="2.8" fill="currentColor" fillOpacity="0.75" />
      {/* Chip EMV */}
      <rect
        x="4.2"
        y="12.6"
        ...
        strokeWidth="0.5"
      />
      {/* Círculos de bandeira (Visa / Mastercard) */}
      <circle cx="16" cy="14.1" r="2.2" fill="#ef4444" fillOpacity="0.85" />
      <circle cx="18.5" cy="14.1" r="2.2" fill="#f59e0b" fillOpacity="0.85" />
    </svg>
  );
}

/**
 * Ícone Profissional Débito Caixa Econômica Federal (X oficial Caixa)
 */
export function CaixaDebitBrandIcon({ className = 'h-5 w-5', ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
      ...
      {...props}
    >
      <title>Cartão de Débito Caixa</title>
      {/* Base do Cartão Caixa */}
      <rect
        x="1.75"
        y="4.5"
        width="20.5"
      ...
      />
      {/* Tarja magnética */}
      <rect x="1.75" y="8" width="20.5" height="2.8" fill="#005ca9" fillOpacity="0.75" />
      {/* Chip EMV */}
      <rect
        x="4.2"
        y="12.6"
        ...
        strokeWidth="0.4"
      />
      {/* "X" estilizado da Caixa em azul e laranja */}
      <g transform="translate(15.2, 12) scale(0.42)">
        {/* Chevron Azul */}
        <path
          d="M2 1L8 7L2 13H5.5L10 8.5L14.5 13H18L12 7L18 1H14.5L10 5.5L5.5 1H2Z"
          fill="#005ca9"
        />
        {/* Detalhe Laranja central Caixa */}
        <path d="M8.5 7L10 5.5L11.5 7L10 8.5L8.5 7Z" fill="#f37021" />
      </g>
    </svg>
  );
}
...
export function BoletoBrandIcon({ className = 'h-5 w-5', ...props }: IconProps) {
  return (
    ...
    >
      ...
      {/* Contorno do documento de boleto com dobra superior */}
      <path
        d="M4 3.5C4 2.67 4.67 2 5.5 2H15.5L20 6.5V20.5C20 21.33 19.33 22 18.5 22H5.5C4.67 22 4 21.33 4 20.5V3.5Z"
        fill="currentColor"
        fillOpacity="0.08"
        stroke="currentColor"
        strokeWidth="1.5"
      ...
      {/* Linhas do código de barras de espessuras variadas */}
      <g fill="currentColor">
        <rect x="7" y="11" width="1.2" height="7" rx="0.3" />
        <rect x="9.2" y="11" width="0.7" height="7" rx="0.3" />
        <rect x="10.8" y="11" width="1.6" height="7" rx="0.3" />
        <rect x="13.2" y="11" width="0.7" height="7" rx="0.3" />
        <rect x="14.8" y="11" width="2" height="7" rx="0.3" />
      </g>
    </svg>
  );
}
