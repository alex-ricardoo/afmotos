...
function MercadoPagoBadge({ className = 'h-10 w-10 sm:h-11 sm:w-11' }: { className?: string }) {
  return (
    <div
      className={`relative flex shrink-0 items-center justify-center rounded-xl bg-white p-1.5 shadow-md shadow-black/40 ring-1 ring-white/30 ${className}`}
      title="Mercado Pago"
    >
      <svg
        role="img"
        ...
        className="h-full w-full fill-[#009EE3]"
        aria-hidden="true"
      >
